 ...
 * @brief Fournit une fonction pour simuler le déplacement du joueur en tenant compte des collisions.
 *
 * @details La fonction canMove() vérifie, pour un mouvement donné du joueur (départ -> arrivée),
 *          si la boîte englobante du joueur intersecte des blocs solides ou opaques du monde. Elle utilise
 *          le ray casting pour déterminer les blocs susceptibles d'entrer en collision.
 *
